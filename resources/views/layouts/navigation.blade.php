<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden items-center gap-1 sm:-my-px sm:ms-8 sm:flex">
                    ...
                    <x-nav-link :href="route('fees.index')" :active="request()->routeIs('fees.*') || request()->is('fee-settings*')">
                        {{ __('Yuran') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('fees.index')" :active="request()->routeIs('fees.*') || request()->is('fee-settings*')">
                {{ __('Yuran') }}
            </x-responsive-nav-link>
